...
class TranslateOrchestrator:
    ...
    def translate_metadata(self, task_type: TaskType, text: str)->QueryResult:
        ...
        for provider in providers:
            ...
            if result.success:
                return result
        return QueryResult(success=False, content=None)
    ...
    def correct_or_translate_subtitle(self, task_type: TaskType, metadata: Dict, text: str)->QueryResult:
        providers = self.providers[task_type]
