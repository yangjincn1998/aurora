...
* **标点符号**：最终输出只能包含翻译后的中文名、逗号 `,` 和英文**半角**括号 `()`。
...
6.  **翻译风格**：朴素平凡、直白露骨，不要添过于繁复的修辞。
   ...
   【推荐】双人解禁 饮尿女同 花咲一杏×七海唯亚 ～用尿液相互加深交爱的羁绊～
...
title_examples = {
    "W解禁飲尿レズビアン 花咲いあん 七海ゆあ 〜オシッコで深め合う愛の絆〜": "双人解禁 饮尿女同 花咲伊安×七海由亚 ～用尿液交织的爱之羁绊～",
    "BBAN-211 僕の彼女の浮気相手は親友の兄貴でした。 仲村つかさ": "我女友的出轨对象，是我挚友的哥哥。仲村司",
    "DVAJ-703 手指とマ○コでザーメンちょいヌキ寸止め繰り返されギリギリ限界チ○ポを爆ピス全ヌキしても責め続け男潮吹きキンタマ枯れるまで杭打ちピストンラッシュ3本番スペシャル 椿りか": "用手指和阴道反复抽插，在极限边缘被爆射，即使完全射出也继续被责罚，直到男性潮吹，睾丸枯竭，被猛烈抽插 3 次特别版 椿丽香"
}
...
synopsis_examples = {
    ...
    人の友人‘さやか’に見られ逆告白、なりゆきでエッチする。こじれた淫らな彼女不在の3日間のハメまくりNTR生活。": "S1苗条美女演员的豪华共演情感剧！\
...
# 规则：
1.  **使用行业标准翻译**：优先使用目标语言文化中最广为人知的翻译。例如，「NTR」应直接翻译为「NTR」或「牛头人」，而不是字面翻译。
